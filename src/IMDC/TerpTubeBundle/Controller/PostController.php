...
class PostController extends Controller
{
	public function indexAction()
	{
		...
		$response = $this->render('IMDCTerpTubeBundle:Post:index.html.twig', array('posts' => $posts));
		return $response;
	}
	...
	public function createNewPostAction(Request $request)
	{
		...
		return $this->render('IMDCTerpTubeBundle:Post:new.html.twig', array('form' => $form->createView(),));
	}
	...
	public function deletePostAction($postid, $threadid)
	{
		...
		{
			$this->get('session')->getFlashBag()->add('error', 'You do not have permission to delete this post');
			return $this->redirect($this->generateUrl('imdc_thread_view_specific', array('threadid' => $threadid)));
		}
	...
	public function editPostAction(Request $request, $pid)
	{
		...
		{
			$this->get('session')->getFlashBag()->add('notice', 'You do not have permission to edit this post');
		...
		if ($posteditform->isValid())
		{
			...
			$this->get('session')->getFlashBag()->add('notice', 'Post edited successfully!');

			return $this
					->redirect(
							$this->generateUrl('imdc_thread_view_specific', array('threadid' => $threadid)) . '#'
									. $postID);
		}
		...
		return $this
				->render('IMDCTerpTubeBundle:Post:editPost.html.twig',
						array('form' => $posteditform->createView(), 'post' => $postToEdit,));
