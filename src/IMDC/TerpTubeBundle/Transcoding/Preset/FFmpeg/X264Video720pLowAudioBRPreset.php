 ...
 */
class X264Video720pLowAudioBRPreset extends BasePreset
{

    protected $key = "ffmpeg.x264_720p_video_low_audio_br";

    protected $name = "X264 Video Preset Low Audio Bitrate";
