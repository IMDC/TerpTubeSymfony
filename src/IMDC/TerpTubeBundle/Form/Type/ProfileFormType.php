...
//		parent::buildForm($builder, $options);
		...
		$builder->add('gender', 'choice', array('empty_value' => 'form.profile.gender.empty', 'choices'=>array('m' => 'form.profile.gender.m', 'f' => 'form.profile.gender.f'), 'required'=>false, 'expanded' => true, 'multiple' => false, 'label' => 'form.profile.gender.title', 'translation_domain' => 'IMDCTerpTubeBundle'));
