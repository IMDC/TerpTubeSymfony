define([ 'core/subscriber', 'core/mediaManager', 'component/recorderComponent', 'component/myFilesSelectorComponent',
	'core/helper', 'extra' ], function(Subscriber, MediaManager, RecorderComponent, MyFilesSelectorComponent,
	Helper)
{
    'use strict';
	...
	this.$selected.find(MediaChooserComponent.Binder.SELECTED_MEDIA).filter('[data-mid="' + media.id + '"]').find(
